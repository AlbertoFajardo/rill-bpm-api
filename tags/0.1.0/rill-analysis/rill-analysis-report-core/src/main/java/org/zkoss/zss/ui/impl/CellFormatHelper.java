...
public class CellFormatHelper {
	...
	public String getInnerHtmlStyle() {
		if (_cell != null) {
			...
			Map<String, String> cfInfo = ConditionalFormattingHelper.getCFInWorkbook(_sheet, _cell);
			if (!CollectionUtils.isEmpty(cfInfo)) {
				for (Entry<String, String> entry : cfInfo.entrySet()) {
