...
public class RegistrationProxyBuilderImpl extends RegistrationProxyBuilder{
    ...
    class RegistrationProxyImpl extends RegistrationProxyF<MemberSubmissionEndpointReference, RegisterType,RegisterResponseType,RegistrationPortTypeRPC> {

        private RegistrationPortTypeRPC port;


        RegistrationProxyImpl() {
            port = service.getRegistrationPortTypeRPCPort(to,getEnabledFeatures());
        }

        public RegistrationPortTypeRPC getDelegate(){
            return port;
        }
