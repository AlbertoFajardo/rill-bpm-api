...
function (out) {
	...
	out.push("<span ecuiZk='type:pop-select;id:", this._popButId, ";target:", this._popPanelId, "'");
	this._options.butWidth && (out.push(" style='width:", this._options.butWidth, "'"));
	out.push("></span>");
	
	out.push("<div ecuiZk='type:pop;id:", this._popPanelId, "' style='width:", this._options.panelWidth, "'>");
	for (var i = 0, o; o = this._items[i++]; ){
        ...
        out.push("<span ecuiZk='", optStr, "'>", o[1], "</span>");
	}
	out.push("</div>");
}